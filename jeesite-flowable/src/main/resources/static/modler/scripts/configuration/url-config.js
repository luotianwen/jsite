...
FLOWABLE.APP_URL = {
    ...
    getImportProcessModelUrl: function () {
        return FLOWABLE.CONFIG.contextRoot + '/base/app/rest/import-process-model';
    },

    getImportProcessModelTextUrl: function () {
        return FLOWABLE.CONFIG.contextRoot + '/base/app/rest/import-process-model/text';
    },
    ...
    getCaseModelImportUrl: function () {
        return FLOWABLE.CONFIG.contextRoot + '/base/app/rest/import-case-model';
    },

    getCaseModelTextImportUrl: function () {
        return FLOWABLE.CONFIG.contextRoot + '/base/app/rest/import-case-model/text';
    },
