...
//	private Office office;	// 归属机构
	...
	private String dataScope;// 数据范围id
...
//	}
	...
	public void setUserRoleString(String userIds) {
...
//	}
	...
	public String toString() {
		return "Role [officeId=" + officeId + ", officeName=" + officeName + ", name=" + name + ", enname=" + enname
				+ ", roleType=" + roleType + ", userType=" + userType + ", dataScope=" + dataScope + ", dataScopeName="
				+ dataScopeName + ", oldName=" + oldName + ", oldEnname=" + oldEnname + ", sysData=" + sysData
				+ ", useable=" + useable + ", user=" + user + ", userList=" + userList + ", menuList=" + menuList
