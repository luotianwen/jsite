...
public class GenUtils {
	...
	public static <T> T fileToObject(String fileName, Class<?> clazz){
		try {
			String pathName = "/template/modules/gen/" + fileName;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		...
		model.put("flowPrefix", model.get("moduleName")+(StringUtils.isNotBlank(genScheme.getSubModuleName())
		...
		model.put("dbType", Global.getProperty("jdbc.type"));
