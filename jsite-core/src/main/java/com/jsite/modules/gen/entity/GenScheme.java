...
public class GenScheme extends DataEntity<GenScheme> {
	...
	public String toString() {
		return "GenScheme [name=" + name + ", category=" + category + ", packageName=" + packageName + ", moduleName="
				+ moduleName + ", subModuleName=" + subModuleName + ", functionName=" + functionName
				+ ", functionNameSimple=" + functionNameSimple + ", functionAuthor=" + functionAuthor + ", genTable="
				+ genTable + ", flag=" + flag + ", replaceFile=" + replaceFile + "]";
	}
