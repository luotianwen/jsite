...
import com.jeesite.common.beanvalidator.BeanValidators;
import com.jeesite.common.config.Global;
import com.jeesite.common.lang.DateUtils;
import com.jeesite.common.lang.StringUtils;
import com.jeesite.common.persistence.Page;
import com.jeesite.common.utils.ImageBase64Util;
import com.jeesite.common.utils.UploadUtils4;
import com.jeesite.common.utils.excel.ExportExcel;
import com.jeesite.common.utils.excel.ImportExcel;
...
public class UserController extends BaseController {
	...
	public String getUserById(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	public String importFile(MultipartFile file , HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			logger.info("===import user size=="+list.size());
				for (User user : list){
					try{
	...
	public String headphoto(User user, HttpServletResponse response, Model model) {
		User currentUser = UserUtils.getUser();
		model.addAttribute("user", currentUser);
		//修改Global 没有私有构造函数，实现懒汉式单例模式.在第一次调用的时候实例化自己！
		//model.addAttribute("Global", Global.getInstance());
