package com.jeesite.common.security.shiro.session;

import com.google.common.collect.Sets;
import com.jeesite.common.config.Global;
import com.jeesite.common.lang.DateUtils;
import com.jeesite.common.lang.StringUtils;
import com.jeesite.common.utils.JedisUtils;
...
public class JedisSessionDAO extends AbstractSessionDAO implements SessionDAO {
	...
	public void update(Session session) throws UnknownSessionException {
		...
		if (request != null){
			...
			// 如果是视图文件，则不更新SESSION
			if (StringUtils.startsWith(uri, Global.getProperty("web.view.prefix"))
					&& StringUtils.endsWith(uri, Global.getProperty("web.view.suffix"))){
				return;
			}
			// 手动控制不更新SESSION
