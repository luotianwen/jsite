...
if (typeof jQuery === "undefined") {
    throw new Error("JSite's JavaScript requires jQuery")
}
    ...
    var js = {
        ...
        confirm: function(message, urlOrFun, data, callback, dataType, async, loadingMessage) {
            ...
            var sendAjax = function() {
                js.loading(loadingMessage == undefined ? js.text("正在处理...") : loadingMessage);
                $.ajax({
                    type: "POST",
                    url: urlOrFun,
                    data: data,
        ...
        ajaxSubmit: function(url, data, callback, dataType, async, message) {
            js.loading(message == undefined ? js.text("正在提交，请稍后...") : message);
